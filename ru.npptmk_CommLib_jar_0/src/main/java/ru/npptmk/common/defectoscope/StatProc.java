...
public class StatProc {
    ...
    */
     ...
     */
    public StatProc(float noise, int dVer) {
     ...
     */
    public StatProc(float noise, int dVer, int tmpsize ){
        this.noise = noise;
        ...
        do {
            ...
            for (int i = st; i < en; i++) {
                if (mas[i] < lU && mas[i] > lD) {
                    smSm += mas[i];
                    coSm++;
                    maxVal = Math.max(maxVal, mas[i]);
                    minVal = Math.min(minVal, mas[i]);
                }
            }
            if (coSm == 0) {
                return false;
    ...
    public synchronized void addItem(short result){
        if (indTmD<tmpData.length){
            tmpData[indTmD] = result;
            indTmD++;
            if (indTmD >= tmpData.length){
                fill = true;
                indTmD = 0;
    ...
    public synchronized void calculate() {
        ...
        indTmD = 0; 
        fill = false;
        Arrays.fill(tmpData, (short)0);
    }

    public int getIndTmD() {
        return indTmD;
    }

    /**
     * Возвращает количество значений в доверительном интервале.
     * @return Количество значений, входящих в доверительный интервал.
     */
    public int getCoSm() {
        return coSm;
    }
    ...
    /**
     * Возвращает максимальное значение из входящих в доверительный интервал.
     * @return Максимальное значение из значений внутри доверительного интервала.
     */
    ...
    /**
     * Возвращает минимальное значение из значений, входящих в доверительный
     * интревал.
     * @return Минимальное значение из значений внутри доверительного интервала.
     */
    ...
    /**
     * Возвращает верхнюю границу доверительного интервала.
     * @return Верхняя граница доверительного интервала.
     */
    public int getLimU() {
        return limU;
    }
    ...
    /**
     * Врзвращает нижнюю границу доверительного интервала.
     * @return Нижняя шраница доверительного интервала.
     */
    public int getLimD() {
        return limD;
    }
    ...
    /**
     * Сброс объекта в исходное состояние для приема новой проции значений.
     */
    public void reset(){
        indTmD = 0; 
        fill = false;
